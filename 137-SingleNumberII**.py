...
converted to long. Thus, value like 0b10000001111111111111111111111111, the
sign bit will be considered as a normal bit of type long.
So we need to consider the negative numbers as special case.
